<?php /* Smarty version 2.6.18, created on 2012-03-28 15:30:09
         compiled from CreateView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_purify', 'CreateView.tpl', 43, false),array('modifier', 'vtiger_imageurl', 'CreateView.tpl', 72, false),array('modifier', 'getTranslatedString', 'CreateView.tpl', 84, false),array('modifier', 'cat', 'CreateView.tpl', 90, false),)), $this); ?>
				...
				<table border=0 cellspacing=0 cellpadding=3 width=100% class="small">
				   <tr>
					...
					<?php if ($this->_tpl_vars['ADVBLOCKS'] != ''): ?>	
						<td style="width:15%" align="center" nowrap class="dvtSelectedCell" id="bi" onclick="fnLoadValues('bi','mi','basicTab','moreTab','normal','<?php echo $this->_tpl_vars['MODULE']; ?>
